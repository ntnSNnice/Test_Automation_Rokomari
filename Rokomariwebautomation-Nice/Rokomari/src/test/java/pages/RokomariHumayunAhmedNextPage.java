...
public class RokomariHumayunAhmedNextPage extends Basepage {
	...
	public By HOVER_BOOK = By.xpath("//div[@title='অন্যভুবন হুমায়ূন আহমেদ']//div[contains(@class,'book-list-wrapper')]");
	public By ADD_TO_CART_BUTTON = By.xpath("//div[@title='অন্যভুবন হুমায়ূন আহমেদ']//div[1]//div[2]//button[1]");
